            ...
            <div class="container mt-5">
                    ...
                    <div class="container h-100">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-inherit h-100">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="Cloud_login.jsp">
                ...
                <div class="row mt-2">
                    <div class="col-6 tm-block-col">
                        <img src="img/cloudlog.jpg" width="540" height="420" />
                    </div>
                    <div class="col-6 tm-block-col">
                        <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                            <center><h1 class="tm-block-title">Cloud Server Login</h1></center>
                            <form action="cloud" method="post" class="tm-login-form">
