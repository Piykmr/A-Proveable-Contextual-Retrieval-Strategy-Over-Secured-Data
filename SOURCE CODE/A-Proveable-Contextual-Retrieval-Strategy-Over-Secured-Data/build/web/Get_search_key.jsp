                ...
                <div class="row tm-content-row">
                    <div class="col-12 tm-block-col">
                        <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                            <center><h2 class="tm-block-title">Get Search Key</h2></center>
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-info" href="get_searchkey.jsp?id=<%=rs.getString("id")%>&name=<%=rs.getString("name")%>&email=<%=rs.getString("email")%>"><i class="fas fa-key"></i>&nbsp;&nbsp;&nbsp;Get Search Key</a></td>
                                    </tr>
                                    <%                                        }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
