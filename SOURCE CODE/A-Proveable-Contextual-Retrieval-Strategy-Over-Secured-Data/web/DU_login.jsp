            ...
            <div class="container mt-5">
                    ...
                    <div class="container h-100">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-inherit h-100">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="DU_login.jsp">
                ...
                <div class="row mt-2">
                    <div class="col-6 tm-block-col">
                        <img src="img/userlogin.jpg" width="540" height="420" />
                    </div>
                    <div class="col-6 tm-block-col">
                        <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                            <center><h1 class="tm-block-title">Data User Login</h1></center>
                            <form action="du_signin.jsp" method="post" class="tm-login-form">
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <a href="du_signup.jsp" class="btn btn-info text-uppercase">
                                        Register!
                                    </a>
                                </div>
                            </form>
