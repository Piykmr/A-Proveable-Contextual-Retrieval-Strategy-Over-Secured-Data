            ...
            <div class="container mt-5">
                ...
                <div class="row mt-2">
                    <div class="col-6 tm-block-col">
                        <img src="img/req.png" width="540" height="420" />
                    </div>
                    <%
                    ...
                    <div class="col-6 tm-block-col">
                        <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                            <center><h1 class="tm-block-title">Download File</h1></center>
                            <form action="view_requested1.jsp" method="post" class="tm-login-form">
                                <div class="form-group">
                                    <input type="hidden" value="<%=fid%>" name="fid">
                                    <input type="hidden" value="<%=time%>" name="time">
                                    <label>Decryption Key</label>
                                    <input type="text" name="dkey" class="form-control" placeholder="Enter Decryption Key" required="required" autocomplete="off" />
                                </div>
