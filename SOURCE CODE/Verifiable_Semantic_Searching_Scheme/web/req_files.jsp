                    ...
                    <div class="container h-100">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-inherit h-100">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="req_files.jsp">
                ...
                <div class="row tm-content-row">
                    <div class="col-12 tm-block-col">
                        <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                            <center><h2 class="tm-block-title">Requested Files</h2></center>
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="file_approve.jsp?fid=<%=rs.getString("fid")%>&time=<%=rs.getString("time")%>&umail=<%=rs.getString("umail")%>" class="btn btn-success btn-circle"><i class="fas fa-check"></i></a></td>
                                        <td><a href="file_reject.jsp?fid=<%=rs.getString("fid")%>&time=<%=rs.getString("time")%>&umail=<%=rs.getString("umail")%>" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></a></td>
                                    </tr>
                                    <%                                        }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
