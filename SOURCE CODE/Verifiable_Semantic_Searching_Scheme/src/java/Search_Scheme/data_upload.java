    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (status) {
                ...
                int i = st.executeUpdate("insert into do_files(doid, doname, enc_data, dkey, time, filekeyword, filename, data, enc_time)values('" + doid + "','" + doname + "','" + encryptedtext + "','" + Dkey + "','" + time + "','" + filekeyword + "','" + file.getName() + "','" + sb.toString() + "','" + encryptTime + "')");
                if (i != 0) {
