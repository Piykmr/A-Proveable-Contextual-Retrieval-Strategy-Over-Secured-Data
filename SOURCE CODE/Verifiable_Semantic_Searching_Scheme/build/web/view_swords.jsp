                    ...
                    <div class="container h-100">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-inherit h-100">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="view_swords.jsp">
                ...
                <div class="row tm-content-row">
                    <div class="col-12 tm-block-col">
                        <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                            <center><h2 class="tm-block-title">Semantic Queries</h2></center>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col">ID</th>
                                        <th scope="col">TOPIC</th>
                                        <th scope="col">SEMANTIC QUERY</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("SELECT * FROM swords");
                                        while (rs.next()) {
                                    %>
                                    <tr>
